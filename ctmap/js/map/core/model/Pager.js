map.core.model.Pager = CT.Class({
	CLASSNAME: "map.core.model.Pager",
	mdata: [],
	markers: [],
	...
	toggle: function() {
		if (this.onOff.innerHTML == "-") {
			...
			map.core.controller.hide(this);
		} else {
			this.onOff.innerHTML = "-";
			map.core.controller.show(this);
		}
	},
	init: function(opts) {
		this.opts = opts;
		this.opts.header = this.opts.header || this.header();
		this.kind = new map.core.model.kinds[CT.parse.capitalize(this.opts.modelName)](this);
